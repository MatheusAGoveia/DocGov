                ...
                <?php if ($activeTab === 'novo_documento'): ?>
                    ...
                    <div class="max-w-3xl mx-auto">
                        ...
                        <div class="mb-6">
                            ...
                            <?php if (!$isEditMode && $isAdmin): ?>
                            <!-- SELETOR SEGMENTADO DE TIPO (somente admin, somente em criação) -->
                            ...
                            <?php elseif (!$isEditMode && !$isAdmin): ?>
                            <!-- EDITOR: label fixo -->
                            <div class="mt-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-[#2c2e33] border border-slate-200 dark:border-[#454956] rounded-md text-xs font-semibold text-slate-700 dark:text-slate-200">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                    Documento
                                </span>
                            </div>
